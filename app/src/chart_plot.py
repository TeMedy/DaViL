...
def prgress_chart(raised, goal, color_theme = 'Blue'):
    df = pd.DataFrame(data={'col1': [raised], 'col2': [goal]})
    plt = create_radial_chart(df, color_theme= color_theme)
    return plt

if __name__ == "__main__":
    plt = prgress_chart(6210, 10000)
    plt.show()
