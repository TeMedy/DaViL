...
class TestDataAnalytics(unittest.TestCase):
  ...
  def test_get_highest_donation_2(self):
    ...
    highest_donations = []
    window_days_list = [("Yesterday", 3)]#, ("Last week", 7), ("Last month", 30), ("Overall in 2017", 365)]
    ...
    print(highest_donations[0])
    self.assertEqual(highest_donations[0][2]['amount_dollar'], '250.00', "Error in finding the highest donor.")
